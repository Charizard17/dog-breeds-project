...
function content_5ff4471dbd4202_05508629 (Smarty_Internal_Template $_smarty_tpl) {
...
<form action="index.php" method="post">
    ...
    <div class="table-row-container table-head">
      <div class="table-col1 item-center"><img class="th-bookmark-icon c-pointer no-self-bg" id="th-bookmark" src="img/star-yellow.png"></div>
      <div class="table-col2 item-center"><span class="c-pointer no-self-bg" id="th-id">ID</span></div>
      <div class="table-col3 item-center">Name</div>
      <div class="table-col4 item-center">Picture</div>
      <div class="table-col5 item-center" id="th-weight"><span class="c-pointer no-self-bg">Weight(kg)</span></div>
      <div class="table-col6 item-center" id="th-height"><span class="c-pointer no-self-bg">Height(cm)</span></div>
      <div class="table-col7 item-center">Temperament</div>
      <div class="table-col8 item-center">Details</div>
    </div>
