...
function content_5ff70d057a3f01_89703656 (Smarty_Internal_Template $_smarty_tpl) {
...
<form action="index.php" method="post">
  <div class="table-outer">
    <div class="table-row-container table-head">
      ...
      <div class="table-col2 text-center"><span class="c-pointer no-self-bg" id="th-name">Name</span></div>
      <div class="table-col3 text-center">Picture</div>
      <div class="table-col4 text-center" id="th-weight"><span class="c-pointer no-self-bg">Weight(kg)</span></div>
      <div class="table-col5 text-center" id="th-height"><span class="c-pointer no-self-bg">Height(cm)</span></div>
      <div class="table-col6 text-center">Temperament</div>
      <div class="table-col7 text-center">Details</div>
    </div>
...
?>
            <?php if ($_smarty_tpl->tpl_vars['key']->value == 'id' || $_smarty_tpl->tpl_vars['key']->value == 'breed_name' || $_smarty_tpl->tpl_vars['key']->value == 'image' || $_smarty_tpl->tpl_vars['key']->value == 'weight' || $_smarty_tpl->tpl_vars['key']->value == 'height' || $_smarty_tpl->tpl_vars['key']->value == 'temperament') {?>
              <?php if ($_smarty_tpl->tpl_vars['key']->value == 'breed_name') {?>
                <div class="table-col2 text-left"><?php echo $_smarty_tpl->tpl_vars['item']->value;?>
</div>
              <?php } elseif ($_smarty_tpl->tpl_vars['key']->value == 'image') {?>
                <div class="table-col3 text-center dog-breed-image"><?php echo smarty_function_html_image(array('file'=>$_smarty_tpl->tpl_vars['item']->value),$_smarty_tpl);?>
</div>
              <?php } elseif ($_smarty_tpl->tpl_vars['key']->value == 'weight') {?>
                <div class="table-col4 text-center"><?php echo $_smarty_tpl->tpl_vars['item']->value['metric'];?>
</div>
              ...
              <?php } elseif ($_smarty_tpl->tpl_vars['key']->value == 'temperament') {?>
                <div class="table-col6 text-left"><?php echo $_smarty_tpl->tpl_vars['item']->value;?>
</div>
              <?php }?>
            <?php }?>
          <?php
...
?>
            <?php if ($_smarty_tpl->tpl_vars['key']->value == 'id') {?>
              <div class="table-col7 text-center">
...
?>
            <?php if ($_smarty_tpl->tpl_vars['key']->value == 'id' || $_smarty_tpl->tpl_vars['key']->value == 'breed_name' || $_smarty_tpl->tpl_vars['key']->value == 'image' || $_smarty_tpl->tpl_vars['key']->value == 'weight' || $_smarty_tpl->tpl_vars['key']->value == 'height' || $_smarty_tpl->tpl_vars['key']->value == 'temperament') {?>
              ...
              <?php } elseif ($_smarty_tpl->tpl_vars['key']->value == 'image') {?>
                <div class="invisible table-col3"><?php echo smarty_function_html_image(array('file'=>$_smarty_tpl->tpl_vars['item']->value),$_smarty_tpl);?>
</div>
              <?php } elseif ($_smarty_tpl->tpl_vars['key']->value == 'weight') {?>
                <div class="invisible table-col4"><?php echo $_smarty_tpl->tpl_vars['item']->value['metric'];?>
</div>
              <?php } elseif ($_smarty_tpl->tpl_vars['key']->value == 'height') {?>
                <div class="invisible table-col5"><?php echo $_smarty_tpl->tpl_vars['item']->value['metric'];?>
</div>
              <?php } elseif ($_smarty_tpl->tpl_vars['key']->value == 'temperament') {?>
                <div class="invisible table-col6"><?php echo $_smarty_tpl->tpl_vars['item']->value;?>
</div>
              <?php }?>
            <?php }?>
          <?php
...
?>
            <?php if ($_smarty_tpl->tpl_vars['key']->value == 'id') {?>
              <div class="invisible table-col7">
                <div class="invisible">
