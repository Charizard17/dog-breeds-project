...
function content_5fe20c9c3f8299_13926348 (Smarty_Internal_Template $_smarty_tpl) {
...
<form action="index.php" method="post">
  <table id="dog-breeds-table" class="dog-breeds-table">
      <thead>
        <tr>
          <th class="dog-breeds-table-th" scope="col"><img class="th-bookmark-icon" src="img/star-yellow.png" alt=""></th>
...
?>
                  <?php if ($_smarty_tpl->tpl_vars['key']->value == 'id') {?>
                    <td class="dog-breeds-table-td">
                      <button value="<?php echo $_smarty_tpl->tpl_vars['item']->value;?>
" id="<?php echo $_smarty_tpl->tpl_vars['item']->value;?>
" class="favourite-star" onclick="myFavourite(this.id)"></button>
                    </td>
                  <?php }?>
                <?php
}
